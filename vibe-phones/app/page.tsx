...
export default function Chat() {
  ...
  const handleQuickAction = (text: string) => {
    // 'append' instantly submits the message to the chatbot
          ...
          {messages.length === 0 ? (
            <div className="h-full flex flex-col items-center justify-center text-center space-y-6 animate-in fade-in duration-500">
              ...
              <p className="text-slate-600 max-w-md">
                Ready to find your next phone? Select a quick action below or type your specific requirements (budget, OS, RAM, camera).
              </p>
